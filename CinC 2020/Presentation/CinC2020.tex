...
\section{Introduction} 
	...
	\begin{frame}{Step-wise Catheter Ablation (CA)}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[scale=1.2,clip=true,trim={3.55cm 21.95cm 13.8cm 2.0cm}]{fig/CA_figure.pdf}
		\end{figure}
...
\section{Methods}
	...
	\begin{frame}{Tensor Approach}
		...
		\begin{figure}[htb]
			\centering
			\includegraphics[scale=0.8,clip=true,trim={0.8cm 6.5cm 0.6cm 6.2cm}]{fig/tikz_BTDY.pdf}
		\end{figure}
		\vspace{2.3cm}
		\begin{itemize}
	...
	\begin{frame}{Tensor Approach}
		...
		\begin{figure}[!ht]
			\centering
			\vspace{-3.5cm}
			\includegraphics[scale=1.0,trim={1.0cm 8.5cm 1.0cm 7.3cm},clip=true]{fig/tikz_tensorHankel.pdf}
		\end{figure}
	\end{frame}
	...
	\begin{frame}{AA Source Estimation}
		...
		\begin{figure}[!ht]
			\centering
			\includegraphics[scale=0.75,trim={3.0cm 8.5cm 3.0cm 8.5cm},clip=true]{fig/example_Source.pdf}
		\end{figure}
		\vspace{-2.0cm}
...
\section{Experimental Results}
	...
	\begin{frame}{Impact of PVI on AA complexity}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[scale=0.9]{fig/boxplot_PVI.pdf}
		\end{figure}
		\vspace{-0.5cm}
		\begin{itemize}
	...
	\begin{frame}{AF Recurrence vs. Complexity Before CA} 
		...
		\begin{figure}[h]
			\centering
			\includegraphics[scale=0.7]{fig/rank_LR.pdf}
		\end{figure}
		\vspace{-0.5cm}
